...
class Locallist(object):
    ...
    def check_rulelist(self,pairs):
        ...
        for loc in name:
            infile=open('./rulelist_tfidf_'+loc,'r')
            for line in infile:
                #print line,loc
    ...
    def tag_pair_distance_at_different_location(self,outfile,eg):
        ...
        tagpair1=[['basketball','rocket','laker','maverick','heat','warrior','bull'],['oil','green'],['business','stock','investment'],['olympic','rugby']]
        tagpair2=[['nba'],['energy'],['finance'],['sport']]
