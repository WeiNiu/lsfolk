...
class Locallist(object):
    ...
    def check_rulelist(self,pairs):
        ...
        for loc in name:
            infile=open('./lc/rulelist_tfidf_new_'+loc,'r')
            for line in infile:
                #print line,loc
    ...
    def tag_pair_distance_at_different_location(self,outfile,eg):
        ...
        tagpair1=[['rocket','laker','maverick','heat','warrior','bull'],['oil','green'],['business','stock','investment']]
        tagpair2=[['nba'],['energy'],['finance']]
...
if __name__=='__main__':
    ...
    eg=2
    l.tag_pair_distance_at_different_location('tagpair_eg_tfidf_'+str(eg),eg)
