...
infile='/spare/wei/folk/cosine_lt10'
...
outfile1=open('centrality_less10_2','w')
for tag,cen in a:
...
nx.write_gml(G,"folksonomy_en_less10_0.1.gml")
print graph_parent_dict
a= build_tree(graph_parent_dict)
print a
outfile2=open('folksonomy_en_less10_0.1','w')
