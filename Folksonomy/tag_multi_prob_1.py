...
filename='/spare/wei/local/user_tag_dict_ch3'#'/spare/wei/user_tag_dict_l1'#'/spare/wei/folk/user_tag_dict_en_lt10_for_prob_1_3'#'/spare/wei/folk/user_tag_dict_en_for_prob'#user_tag_dict_greater_than_3000'
#filename='/spare/wei/folk/user_tag_dict_ny_u5_10'
outfile='/spare/wei/links'
out=open(outfile,'w')
outfile1='/spare/wei/local/tag-tag-dict_ch3'#'./link-dict_en_lt10_3'
...
for line in open(filename):
    ...
    for tag,value in tagdict.iteritems():
        ...
        for tag1,value1 in tagdict.iteritems():
            if tag != tag1 and tag1+'_'+tag not in tag_dict:
