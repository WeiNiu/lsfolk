...
name=['chicago','ny','la','sf','houston','miami','london','sydney','seattle','dallas']
...
class Locallist(object):
    ...
    def tag_pair_distance_at_different_location(self,outfile):
        ...
        tagpair1=[['rocket','laker','maverick','heat','warrior','bull'],['oil','green'],['business','stock','investment'],['olympic']]
        tagpair2=[['nba'],['energy'],['finance']]
        pairs = self.construct_pair(tagpair1[2],tagpair2[2])
        print pairs
...
if __name__=='__main__':
    ...
    l.tag_pair_distance_at_different_location('tagpair_eg')
