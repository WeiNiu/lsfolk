...
#                key1=tag1+'_'+tag
    ...
    def predict_bulk(self,groud_truth,user_tag_dict,num_to_predict,pcd,tfd,ruledict,removelist):
        ...
        for user,ground_truth_a_user in groud_truth.iteritems():
            ...
            tag_order_a_user,avg=self.comp_candidate_order_cnt(self, pcd, tfd, a_users_tag_dict,ruledict,removelist)#comp_candidate_order_mix(pcd,tfd,user_tag_dict_a_user,ruledict,removelist)
            #print tag_order_a_user
...
if __name__ =='__main__':
    ...
    gpd_file=sys.argv[1]
    #gpd_file='/Users/wei/Documents/folk_exp/backbone/graph/gpd2_hou'
    ...
    rulelist_file=sys.argv[5]#'/Users/wei/Documents/folk_exp/backbone/lc/rulelist_hou'
