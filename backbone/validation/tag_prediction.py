...
class TagPrediction(object):
    ...
    def parent_child_dict_from_gpd(self,gpd):
        ...
        for key,value in gpd.items():    
            pcd[key]['p']=value
            value0=value[0]#value[0]
            if 'c' not in pcd[value0]:
                pcd[value0]['c']={}
            pcd[value0]['c'][key]=value[1]
        return pcd
...
#                key1=tag1+'_'+tag
            ...
            if 'c' in pcd[tag]:
                for key,value in pcd[tag]['c'].items():
                    if key not in tag:
                        ...
                        order.append((key,mix))
                sumcandidate+=len(pcd[tag]['c'])
            avgcan.append(sumcandidate)
        #order=set(order)
        order=sorted(order,key=itemgetter(1),reverse=1)
        avg=sum(avgcan)/len(avgcan)
        return order,avg        
    ...
    def predict_a_user(self, ground_truth_a_user, tag_order_a_user, num_to_predict):
        ...
        #print accuracy
        #cost=sum(lengthorder)/len(lengthorder)
...
if __name__ =='__main__':
    ...
    gpd_file='/Users/wei/Documents/folk_exp/backbone/lc/gpd_hou'
    gpd_file='/Users/wei/Documents/folk_exp/backbone/graph/gpd2_ny'
    ground_truth_file='/Users/wei/Documents/folk_exp/backbone/validation/user_tag_dict_ny_selected'
    user_tag_dict_file='/Users/wei/Documents/folk_exp/backbone/validation/user_tag_dict_ny_selected_part1'
    tag_freq_dict_file='/Users/wei/Documents/folk_exp/backbone/lc/tag_freq_dict_ny'
    rulelist_file='/Users/wei/Documents/folk_exp/backbone/lc/rulelist_ny'
    removelist='/Users/wei/Documents/folk_exp/backbone/lc/removelist_ny'
    ...
    pcdfile=open('pcd','w')
    pcdfile.write(cjson.encode(pcd))
